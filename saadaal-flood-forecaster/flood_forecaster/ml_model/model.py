...
def infer_from_raw_data(model, infer_fn, station_metadata, stations_df, weather_df, station_lag_days, weather_lag_days, forecast_days):
    df = preprocess_diff(
        station_metadata, 
